...
; symbol _Z21gemm_rs_mi300x_kernelILi256ELi256ELi32ELb1EEv14mi300x_globals
; <256,256,32,true>
; innermost mfma loop = lines 16012..16438 ; dumped 15932..16518 with context
     15932| 	v_mov_b32_e32 v50, v2
     15933| 	v_mov_b32_e32 v51, v2
     15934| 	v_mov_b32_e32 v52, v2
     15935| 	v_mov_b32_e32 v53, v2
     15936| 	v_mov_b32_e32 v54, v2
     15937| 	v_mov_b32_e32 v55, v2
     15938| 	v_mov_b32_e32 v56, v2
     15939| 	v_mov_b32_e32 v57, v2
     15940| 	v_mov_b32_e32 v58, v2
     15941| 	v_mov_b32_e32 v59, v2
     15942| 	v_mov_b32_e32 v60, v2
     15943| 	v_mov_b32_e32 v61, v2
     15944| 	v_mov_b32_e32 v62, v2
     15945| 	v_mov_b32_e32 v63, v2
     15946| 	v_mov_b32_e32 v64, v2
     15947| 	v_mov_b32_e32 v65, v2
     15948| 	v_mov_b32_e32 v66, v2
     15949| 	v_mov_b32_e32 v67, v2
     15950| 	v_mov_b32_e32 v68, v2
     15951| 	v_mov_b32_e32 v69, v2
     15952| 	v_mov_b32_e32 v70, v2
     15953| 	v_mov_b32_e32 v71, v2
     15954| 	v_mov_b32_e32 v72, v2
     15955| 	v_mov_b32_e32 v73, v2
     15956| 	v_mov_b32_e32 v74, v2
     15957| 	v_mov_b32_e32 v75, v2
     15958| 	v_mov_b32_e32 v76, v2
     15959| 	v_mov_b32_e32 v77, v2
     15960| 	v_mov_b32_e32 v78, v2
     15961| 	v_mov_b32_e32 v79, v2
     15962| 	v_mov_b32_e32 v80, v2
     15963| 	v_mov_b32_e32 v81, v2
     15964| 	v_mov_b32_e32 v82, v2
     15965| 	v_mov_b32_e32 v83, v2
     15966| 	v_mov_b32_e32 v84, v2
     15967| 	v_mov_b32_e32 v85, v2
     15968| 	v_mov_b32_e32 v86, v2
     15969| 	v_mov_b32_e32 v87, v2
     15970| 	v_mov_b32_e32 v88, v2
     15971| 	v_mov_b32_e32 v89, v2
...
>>   16438| 	s_branch .LBB4_86
     ...
     16479| 	v_mul_lo_u32 v145, v144, s82
     16480| 	v_sub_u32_e32 v138, v138, v145
     16481| 	v_add_u32_e32 v145, 1, v144
     16482| 	v_cmp_le_u32_e32 vcc, s82, v138
     16483| 	v_xor_b32_e32 v143, s23, v143
     16484| 	s_nop 0
     16485| 	v_cndmask_b32_e32 v144, v144, v145, vcc
     16486| 	v_subrev_u32_e32 v145, s82, v138
     16487| 	v_cndmask_b32_e32 v138, v138, v145, vcc
     16488| 	v_add_u32_e32 v145, 1, v144
     16489| 	v_cmp_le_u32_e32 vcc, s82, v138
     16490| 	s_nop 1
     16491| 	v_cndmask_b32_e32 v138, v144, v145, vcc
     16492| 	v_xor_b32_e32 v138, v138, v143
     16493| 	v_sub_u32_e32 v138, v138, v143
     16494| 	v_mad_u64_u32 v[142:143], s[28:29], v142, s40, v[138:139]
     16495| 	v_mul_lo_u32 v138, v142, s41
     16496| 	v_add_u32_e32 v142, s27, v138
     16497| 	v_readlane_b32 s28, v255, 11
     16498| 	v_ashrrev_i32_e32 v143, 31, v142
     16499| 	v_readlane_b32 s29, v255, 12
     16500| 	s_nop 1
     16501| 	v_lshl_add_u64 v[142:143], v[142:143], 2, s[28:29]
     16502| 	flat_load_dword v138, v[142:143] offset:256 sc0 sc1
     16503| 	s_waitcnt vmcnt(0) lgkmcnt(0)
     16504| 	v_cmp_lt_u32_e32 vcc, v138, v205
     16505| 	s_and_b64 exec, exec, vcc
     16506| 	s_cbranch_execz .LBB4_101
     16507| ; %bb.95:                               ; %.lr.ph.i.i.i.preheader
     16508|                                         ;   in Loop: Header=BB4_84 Depth=1
     16509| 	s_mov_b64 s[28:29], 0
     16510| 	s_mov_b64 s[94:95], 0
     16511|                                         ; implicit-def: $sgpr30_sgpr31
     16512|                                         ; implicit-def: $sgpr92_sgpr93
     16513| 	s_branch .LBB4_97
     16514| .LBB4_96:                               ; %Flow2200
     16515|                                         ;   in Loop: Header=BB4_97 Depth=2
     16516| 	s_and_b64 s[52:53], exec, s[92:93]
     16517| 	s_or_b64 s[28:29], s[52:53], s[28:29]
     16518| 	s_andn2_b64 s[30:31], s[30:31], exec
