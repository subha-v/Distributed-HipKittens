import os
# 1015_033901 gen by commit: 2ef1d2
...
(512, 1536, 4096): {'BLOCK_M': 64, 'BLOCK_N': 64, 'BLOCK_K': 256, 'waves_per_eu': 2, 'matrix_instr_nonkdim': 16, 'kpack': 1, 'num_warps': 8, 'num_ctas': 1, 'num_stages': 2, "SLEEP_CYCLE": 200}, # try test it's time.
(2048, 360, 2880): {'BLOCK_M': 64, 'BLOCK_N': 32, 'BLOCK_K': 128, 'waves_per_eu': 2, 'matrix_instr_nonkdim': 16, 'kpack': 1, 'num_warps': 8, 'num_ctas': 1, 'num_stages': 2, "SLEEP_CYCLE": 200},
(4096, 512, 4096): {'BLOCK_M': 128, 'BLOCK_N': 64, 'BLOCK_K': 128, 'waves_per_eu': 2, 'matrix_instr_nonkdim': 16, 'kpack': 1, 'num_warps': 8, 'num_ctas': 1, 'num_stages': 2, "SLEEP_CYCLE": 200}, # may try send 6 ?
(8192, 1792, 4096): {'BLOCK_M': 256, 'BLOCK_N': 128, 'BLOCK_K': 64, 'waves_per_eu': 2, 'matrix_instr_nonkdim': 16, 'kpack': 1, 'num_warps': 8, 'num_ctas': 1, 'num_stages': 2, "SLEEP_CYCLE": 200},
(8192, 3696, 8192): {'BLOCK_M': 256, 'BLOCK_N': 256, 'BLOCK_K': 64, 'waves_per_eu': 2, 'matrix_instr_nonkdim': 16, 'kpack': 1, 'num_warps': 8, 'num_ctas': 1, 'num_stages': 2, "SLEEP_CYCLE": 200}, #'NUM_KSPLIT': 1,  'SPLITK_BLOCK_SIZE': 8192},
}
