 ...
 * no wait, fence, completion update, or cache hint. gfx942 O3 twins emitted one
 * `flat_store_dwordx4` for this source shape; keep the 16-byte type and direct
 * assignment intact when comparing future ISA.
 */
