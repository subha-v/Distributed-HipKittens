/**
 * @file
 * @brief CDNA4 ordering building blocks for distributed payload lifetime.
 */
...
#if defined(__HIP_DEVICE_COMPILE__)
    // Keep scope strings explicit: they select different gfx950 cache actions.
 ...
 * at the selected scope before publication. The gfx950 system-scope donor
 * lowering was `buffer_wbl2 sc1`; re-check that fingerprint for every
 * target/toolchain.
 */
